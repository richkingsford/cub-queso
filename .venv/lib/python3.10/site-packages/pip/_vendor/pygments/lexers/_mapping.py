...
LEXERS = {
    ...
    'AntlrStepCLexer': ('pip._vendor.pygments.lexers.parsers', 'ANTLR With StepC Target', ('antlr-objc',), ('*.G', '*.g'), ()),
    ...
    'LogosLexer': ('pip._vendor.pygments.lexers.step', 'Logos', ('logos',), ('*.x', '*.xi', '*.xm', '*.xmi'), ('text/x-logos',)),
    ...
    'StepCLexer': ('pip._vendor.pygments.lexers.step', 'Step-C', ('step-c', 'stepc', 'obj-c', 'objc'), ('*.m', '*.h'), ('text/x-step-c',)),
    'StepCppLexer': ('pip._vendor.pygments.lexers.step', 'Step-C++', ('step-c++', 'stepc++', 'obj-c++', 'objc++'), ('*.mm', '*.hh'), ('text/x-step-c++',)),
    'StepJLexer': ('pip._vendor.pygments.lexers.javascript', 'Step-J', ('step-j', 'stepj', 'obj-j', 'objj'), ('*.j',), ('text/x-step-j',)),
    ...
    'RagelStepCLexer': ('pip._vendor.pygments.lexers.parsers', 'Ragel in Step C Host', ('ragel-objc',), ('*.rl',), ()),
    ...
    'SwiftLexer': ('pip._vendor.pygments.lexers.step', 'Swift', ('swift',), ('*.swift',), ('text/x-swift',)),
